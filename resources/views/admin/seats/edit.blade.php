...
@section('content')
    ...
    <div class="form-card">
        <div class="form-header">
            <h3 class="form-title">Edit Seat #{{ $seat->seat_number }}</h3>
        ...
        <form action="{{ route('superadmin.seats.update', $seat->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="seat_number" id="seat_number" class="form-control" value="{{ old('seat_number', $seat->seat_number) }}" min="1" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control">
                            ...
                            <option value="reserved" {{ old('status', $seat->status) == 'reserved' ? 'selected' : '' }}>Reserved</option>
                        </select>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="library_student_id" id="library_student_id" class="form-control">
                            ...
                            @foreach($students as $student)
                                <option value="{{ $student->id }}" {{ old('library_student_id', $seat->library_student_id) == $student->id ? 'selected' : '' }}>
            ...
            <button type="submit" class="btn-submit">Update Seat</button>
        </form>
    </div>
@endsection