...
<div class="student-form-card">
    <div class="form-header">
        <h3 class="form-title">Edit Library Student</h3>
    ...
    <form action="{{ route('superadmin.library-students.update', $student->id) }}" method="POST">
        @csrf
        @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <select name="seat" id="seat_id" class="form-control">
                        ...
                        <option value="{{ $seat->seat_number }}"
                            {{ old('seat', $student->seat ?? '') == $seat->seat_number ? 'selected' : '' }}>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="fee" id="fee" class="form-control" value="{{ old('fee', $student->fee) }}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="membership_date">Membership Date</label>
                    <input type="date" name="membership_date" id="membership_date" class="form-control" value="{{ old('membership_date', $student->membership_date ? $student->membership_date->format('Y-m-d') : date('Y-m-d')) }}">
                </div>
            </div>
        </div>
