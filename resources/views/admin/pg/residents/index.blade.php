...
<div class="student-table-card">
    <div class="student-table-header">
        <h3 class="student-table-title">Residents</h3>
        <a href="{{ route('superadmin.pg-residents.create') }}" class="btn-primary">
            + Add New Resident
        </a>
    </div>
    ...
    <!-- Search Form -->
    <form method="GET" action="{{ route('superadmin.pg-residents.index') }}" class="search-form">
        ...
        @if(request('search'))
        <a href="{{ route('superadmin.pg-residents.index') }}" class="btn-clear">Clear</a>
        @endif
    </form>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('superadmin.pg-residents.status', $resident->id) }}" method="POST">
                            ...
                            <button type="submit" style="border:none; cursor:pointer;"
                                class="{{ $resident->status == 'active' ? 'badge-active' : 'badge-inactive' }}">
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="{{ route('superadmin.pg-residents.show', $resident->id) }}" class="btn-action btn-view">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('superadmin.pg-residents.edit', $resident->id) }}" class="btn-action btn-edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('superadmin.pg-residents.destroy', $resident->id) }}" method="POST"
